...
#parser.add_argument("--index_epoch", "-i", help="index of epochs")
#args = parser.parse_args()
#
#if args.index_epoch is None:
#    sys.exit("\nIndex of epochs is not provided.\n")
#else:
#    index_epoch = int(args.index_epoch)
##print("WT29:", index_epoch)
...
#        print(" Time Taken: {:15.6f}".format(elapsed/100))
        print("  Batch {:3}/{}, Loss1: {:15.6f}, Loss2: {:15.6f}, Loss_tot: {:15.6f}".format(batch_idx, len(batch_loader), loss1.item(), loss2.item(), loss1.item() + loss2.item()))
