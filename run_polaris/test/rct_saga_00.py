...
def main():
    try:
        ...
        jd.arguments       = ['TW_test']
        jd.output          = "/home/twang3/myWork/exalearn_project/run_polaris/test/my.stdout"
        jd.error           = "/home/twang3/myWork/exalearn_project/run_polaris/test/my.stderr"
