...
if __name__ == '__main__':
	...
	# Tianle: Here we try to set up them manually!
        ...
        for i in range(0, n):
            ...
            td.cpu_processes  = 1
            td.pre_exec = ["echo pre_exec: $RADICAL_PROFILE $RP_PILOT_SANDBOX $RADICAL_BASE $RADICAL_SMT $SAGA_PPN"]

            td.pre_launch = ["echo pre_launch: $RADICAL_PROFILE $RP_PILOT_SANDBOX $RADICAL_BASE $RADICAL_SMT $SAGA_PPN"]
            tds.append(td)
            report.progress()
